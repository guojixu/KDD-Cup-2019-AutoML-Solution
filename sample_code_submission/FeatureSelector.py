...
#                 model = lgb.LGBMClassifier(n_estimators=100, learning_rate=0.05, verbose=-1, n_jobs=4)
#
#             elif task == 'regression':
#                 model = lgb.LGBMRegressor(n_estimators=100, learning_rate=0.05, verbose=-1, n_jobs=4)
#
#             else:
